...
IncludeFile("Lib\\minionManager.lua")
...
function VPrediction:LoadToMenu(menu)
	self.menu = menu
	self.Mode = self.tsMenu.addItem(MenuStringList.new("Cast Mode", {"Fast", "Medium", "Slow"}, 1))
	self.menu_advanced = self.menu.addItem(SubMenu.new("Collision"))
	self.menu_advanced_Buffer = self.menu_advanced.addItem(MenuSlider.new("Collision buffer", 20, 0, 100, 1))
	self.menu_advanced_Minions = self.menu_advanced.addItem(MenuBool.new("Normal minions", true))
	self.menu_advanced_Mobs = self.menu_advanced.addItem(MenuBool.new("Jungle minions", true))
	self.menu_advanced_Others = self.menu_advanced.addItem(MenuBool.new("Others", true))
	self.menu_advanced_CHealth = self.menu_advanced.addItem(MenuBool.new("Check if minions are about to die", true))
	self.menu_advanced_UnitPos = self.menu_advanced.addItem(MenuBool.new("Check collision at the unit pos", true))
	self.menu_advanced_CastPos = self.menu_advanced.addItem(MenuBool.new("Check collision at the cast pos", true))
	self.menu_advanced_PredictPos = self.menu_advanced.addItem(MenuBool.new("Check collision at the predicted pos", true))
	self.menu_developers = self.menu.addItem(SubMenu.new("Developers"))
	self.menu_developers_Debug = self.menu_developers.addItem(MenuBool.new("Enable debug", true))
	self.menu_developers_SC = self.menu_developers.addItem(MenuBool.new("Show collision", true))
end
